...
import ca.weindex.weibo4j.http.ImageItem;
import ca.weindex.weibo4j.model.Emotion;
...
import ca.weindex.weibo4j.util.WeiboConfig;
...
public class Timeline extends Weibo{
	 ...
	 * @version ca.weindex.weibo4j-V2 1.0.1
	 * @see <a
	 ...
	 * @throws WeiboException
	 *             when Weibo service or network is unavailable
	 * @version ca.weindex.weibo4j-V2 1.0.0
	 * @see <a
	 *      href="http://open.weibo.com/wiki/2/statuses/public_timeline">statuses/public_timeline
	 *      </a>
	 * @since JDK 1.5
